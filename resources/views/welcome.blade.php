        ...
        <footer class="w-full relative z-10 bg-[#0a1831] mt-12 border-t-2 border-gold/40 shadow-2xl">
            ...
            <div class="w-full bg-[#0a1831] py-8">
                <div class="max-w-7xl mx-auto px-6 flex flex-col items-center justify-center gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        <!-- Facebook -->
                        <a href="#" class="w-12 h-12 rounded-full bg-[#1877F2]/10 text-[#1877F2] border border-[#1877F2]/20 flex items-center justify-center hover:bg-[#1877F2] hover:text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#1877F2]/30">
                        ...
                        <!-- Instagram -->
                        <a href="#" class="w-12 h-12 rounded-full bg-pink-500/10 text-pink-500 border border-pink-500/20 flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-pink-500 hover:to-purple-500 hover:text-white transition-all duration-300 hover:-translate-y-1 hover:border-transparent hover:shadow-lg hover:shadow-pink-500/30">
