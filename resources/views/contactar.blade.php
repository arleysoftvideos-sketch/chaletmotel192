...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Chalet Motel 192 - {{ __('Contáctanos') }}</title>
            ...
            <div class="bg-navy p-8 sm:p-12 rounded-[2rem] border border-blue-900/40 shadow-2xl space-y-8">
                ...
                <div class="text-center space-y-2">
                    ...
                    <p class="text-sm text-slate-400 max-w-md mx-auto">
                        {{ __('¿Tienes dudas sobre las tarifas a largo plazo o disponibilidad? Déjanos un mensaje y te responderemos pronto.') }}
                    </p>
                ...
                @if ($errors->any())
                    <div class="bg-rose-500/10 border border-rose-500/25 text-rose-400 p-4 rounded-xl space-y-1 text-sm">
                        <p class="font-bold">{{ __('Por favor corrige los siguientes errores:') }}</p>
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="message" id="message" rows="5" required
                            placeholder="{{ __('Escribe tu mensaje o pregunta aquí...') }}"
