...
<div class="container no-print" id="app-view">
    ...
    <!-- Hero Section (Contained Banner Card from welcome page) -->
    <div class="w-full pt-2 pb-6 relative z-10 no-print">
        <!-- Contained Hero Banner Box -->
        <div class="hero-banner-contained w-full rounded-[1.5rem] border border-blue-900/40 p-6 sm:p-10 min-h-[300px] flex items-center shadow-2xl relative overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-center w-full">
                
                <!-- Left Column (Flyer Text) -->
                <div class="md:col-span-8 flex flex-col space-y-4 relative z-10 text-left">
                    <!-- Main Title: MOTEL RENTALS -->
                    <div class="space-y-0.5">
                        <span class="block text-3xl sm:text-4xl font-black font-outfit text-white leading-none tracking-tight">
                            MOTEL
                        </span>
                        <span class="block text-4xl sm:text-5.5xl font-black font-outfit text-gold leading-none tracking-tight">
                            RENTALS
                        </span>
                    </div>

                    <!-- Ribbon: LONG TERM STAYS -->
                    <div class="inline-block bg-[#0284c7] px-4 py-1.5 text-center text-white font-black font-outfit text-sm sm:text-md tracking-wider uppercase clip-ribbon shadow-lg shadow-sky-600/10 max-w-xs">
                        Long Term Stays
                    </div>
                    ...
                    <div class="flex items-center gap-3 max-w-xs">
                        ...
                        <span class="text-gold font-extrabold text-[10px] sm:text-xs tracking-widest whitespace-nowrap uppercase">
                            6 Month to 1 Year
                        </span>
                        <div class="h-[1px] bg-gold/50 flex-grow"></div>
                    </div>
                    ...
                    <div class="flex flex-col">
                        <span class="text-4xl sm:text-5xl font-black font-outfit text-gold leading-none">
                            $1,200
                        </span>
                        <div class="flex items-center gap-2 mt-0.5">
                            <div class="h-[1px] w-6 bg-white/40"></div>
                            <span class="text-white/70 font-extrabold uppercase tracking-widest text-[9px] sm:text-[10px]">
                                Per Month
                            </span>
                            <div class="h-[1px] w-6 bg-white/40"></div>
                        </div>
                ...
                <div class="md:col-span-4 flex justify-center md:justify-end relative">
                    ...
                    <div class="w-24 h-24 sm:w-28 sm:h-28 bg-gold rounded-full flex flex-col items-center justify-center text-center text-navy p-2 shadow-2xl animate-bounce hover:scale-105 transition-transform duration-300">
                        ...
                        <div class="relative z-10 flex flex-col items-center">
                            ...
                            <span class="block text-[11px] font-black font-outfit leading-tight uppercase text-navy">First</span>
                            <span class="block text-[14px] font-black font-outfit leading-none uppercase text-navy">Month</span>
                            <span class="block text-[14px] font-black font-outfit leading-none uppercase text-navy">Free!</span>
